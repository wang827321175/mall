...
<div class="w loc">
	<div class="h-title">
		<div class="h-logo"><a href="http://localhost:8080">
			<img src="/jsutils/img/pic/logo-2.png" />
		</a></div>
	    <div class="h-search">
	      	<input type="text" />
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="../buyer/deliver_addjsutilss.jsp" title="收货地址">收货地址</a></li>
		...
		<tbody>        
			<tr class="over">
				...
				<td class="nwp pic">
					<ul class="uls">
						<li>
							<a href="#" title="依琦莲2014瑜伽服套装新款" class="pic"><img src="../../jsutils/img/pic/p50x50.jpg" alt="依琦莲2014瑜伽服套装新款" /></a>
							<dl>
