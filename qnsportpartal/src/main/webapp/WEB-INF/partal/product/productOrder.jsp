...
<form action="/order/submitOrder.html" method="post">
<div class="w ofc case">
	<h2 class="h2 h2_r mt"><em title="收货人信息">收货人信息      [<a href="#"><font style="color:blue;">修改</font></a>]</em><cite></cite></h2>
	<div class="box bg_white">
		<dl class="distr">
			<dd>${addr.name }   ${addr.phone }<span style="margin-left: 30px">${addr.name }   ${addr.phone }   ${addr.addr}</span></dd>
		</dl>
	</div>
	...
	<div class="box bg_white pb">
		...
		<tbody>
			<tr>
				...
				<td class="img48x20">
					<span class="inb"><img src="/jsutils/img/pic/ppp.jpg"></span>
			...
			<tr>
				<td>20141028114510004</td>
				<td class="img48x20">
					<span class="inb"><img src="/jsutils/img/pic/ppp1.jpg"></span>
			...
			<tr>
				<td>20141028114510004</td>
				<td class="img48x20">
					<span class="inb"><img src="/jsutils/img/pic/ppp2.jpg"></span>
