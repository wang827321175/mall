...
<div class="sign">
	...
	<div class="r">
		<h2 title="登录">登录</h2>
		<form id="jvForm" action="/userLogin.do" method="post">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img src="/login/getCode.do" onclick="this.src='/login/getCode.html?d='+new Date()" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="$('.code').attr('src','/login/getCode.html?d='+new Date())" title="换一张">换一张</a></li>
