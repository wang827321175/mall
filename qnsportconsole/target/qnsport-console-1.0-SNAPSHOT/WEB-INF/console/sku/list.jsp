...
<head>
    ...
    <script type="text/javascript">
        function addSku(skuId) {
            ...
            var u = $("#u" + skuId).attr("disabled", true).val();

            var url = "/sku/update.do";
            //参数
            var params = {"marketPrice": m, "price": p, "stock": s, "upperLimit": u, "id": skuId};
            ...
            <c:forEach items="${skus }" var="sku">
                <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                    ...
                    <td align="center"><input type="text" id="s${sku.id }" value="${sku.stock}" disabled="disabled"
                                              size="10"/></td>
                    <td align="center"><input type="text" id="u${sku.id }" value="${sku.upperLimit}" disabled="disabled"
                                              size="10"/></td>
