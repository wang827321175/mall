            ...
            $("#tabs a").each(function () {
                ...
                $(this).click(function () {
                    ...
                    if (ref == '#tab_2') {
                        ...
                        fck.Height = 400;
                        //设置上传路径
                        fck.Config["ImageUploadURL"] = "/upload/fckImg.do";
                        //把数据同步到 textarea
                        fck.ReplaceTextarea();
                    }
                });
...
<div class="box-positon">
    ...
    <form class="ropt">
        <input type="submit" onclick="this.form.action='/store/list.do';" value="返回列表" class="return-button"/>
    </form>
    <div class="clear"></div>
</div>
<h2 class="h2_ch"><span id="tabs">
<a href="javascript:void(0);" ref="#tab_1" title="基本信息" class="here">基本信息</a>
<a href="javascript:void(0);" ref="#tab_2" title="商铺描述" class="nor">商铺描述</a>
<%--<a href="javascript:void(0);" ref="#tab_3" title="商品参数" class="nor">包装清单</a>--%>
</span></h2>
<div class="body-box" style="float:right">
    <form id="pForm" action="/store/save.do" method="post" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
           ...
           <%-- <tr>
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <input type="text" class="required" name="name" value="${store.name}" maxlength="100" size="100"/>
                </td>
            </tr>
            <%--<tr>
                <td width="20%" class="pn-flabel pn-flabel-h">
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <input type="text" class="required" name="weight" maxlength="10"/>KG
                </td>
            </tr>
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    <c:forEach items="${features }" var="feature">
                        <input type="checkbox" value="${feature.id }" name="featujsutils"/>${feature.name }
                    </c:forEach>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    ...
                    <input type="hidden" name="img.url" id="himg"/>
                </td>
            </tr>--%>
            </tbody>
            ...
            <tr>
                <td>
                    <textarea rows="10" cols="10" id="productdesc" name="description">${store.description}</textarea>
                </td>
            </tr>
            </tbody>
